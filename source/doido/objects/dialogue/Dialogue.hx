package doido.objects.dialogue;
...
import doido.objects.dialogue.DialogueObjects;
import doido.objects.menu.Alphabet;
...
class Dialogue extends FlxGroup
{
	...
	override function update(elapsed:Float)
	{
		...
		if(Controls.justPressed(TEXT_LOG)) {
			...
			FlxG.state.openSubState(new doido.subStates.DialogueHistorySubState(pastData));
		}
