...
import doido.objects.*;
import doido.objects.hud.*;
import doido.objects.note.*;
import doido.objects.dialogue.Dialogue;
import shaders.*;
import doido.states.editors.*;
import doido.states.menu.*;
import doido.subStates.*;

#if TOUCH_CONTROLS
import doido.objects.mobile.Hitbox;
#end
