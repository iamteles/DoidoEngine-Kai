...
import doido.objects.Character;
import doido.objects.hud.Rating;
import doido.objects.menu.DoidoSlider;
import doido.states.*;
import doido.subStates.editors.ChooserSubState;
