...
class FlxCamera extends FlxBasic
{
	...
	function updateLerp(elapsed:Float)
	{
		...
		{
			scroll.x = FlxMath.lerp(scroll.x, _scrollTarget.x, lerp);
			scroll.y = FlxMath.lerp(scroll.y, _scrollTarget.y, lerp);
		}
	}
	 ...
	 * @param   style    Leverage one of the existing "deadzone" presets. Default is `CENTER`.
